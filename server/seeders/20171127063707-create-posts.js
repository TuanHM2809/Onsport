    ...
    */
    ...
    var dataTest = _.times(100, n => {
      ...
      return {
        title: name,
        slug: slugUrl,
        short_title: faker.lorem.words(),
        short_description: faker.lorem.sentence(),
        featured: faker.random.boolean(),
        breaking_news: faker.random.boolean(),
        content: faker.lorem.paragraph(),
        thumbnail: faker.random.arrayElement(array_thumbnailMovie),
        poster: faker.random.arrayElement(array_thumbnailMovie),
        post_type: faker.random.arrayElement([Constant.NORMAL_TYPE, Constant.LONGFORM_TYPE])
      }
    })
    return queryInterface.bulkInsert('articles', dataTest, {}).then(() => {
